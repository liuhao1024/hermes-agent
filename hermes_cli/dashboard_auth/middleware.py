...
def _auto_sso_response(request: Request) -> Response | None:
    ...
    # redirect — their start_login() raises NotImplementedError.  Let the
    # /login interstitial render the password form instead of bouncing to
    # /auth/login which would crash.
