...
def interruptible_streaming_api_call(agent, api_kwargs: dict, *, on_first_delta=None):
    ...
    def _call_chat_completions():
        ...
        if tool_calls_acc:
            # Detect mixed-function batches before splitting concatenated args.
            # If index=None parallel batch contains different function names,
            # we cannot safely split because we don't know which split object
            # belongs to which function. Guard: check if all tool_calls_acc
            # entries have the same non-empty function name (#62937).
            ...
            for idx in sorted(tool_calls_acc):
                ...
                if arguments and arguments.strip():
                    try:
                        ...
                        if split_args and not has_mixed_functions:
